*=====================================================================================================================================================================
*Date: September 2021 --> Latest Update: January 2022
...
*data. 
*
*database used: AdvMathIncomeRankQuantile.csv
*				
*output: AdvMathIncRankQuantControlsDepVars.dta
*
*key variables: -sex
*				-race/ethnicity
*				-birth month
...
log using "C:\Users\jcoger\Documents\Essay1\AdvMathWork\AdvMathIncomeRankQuantileV1\logfiles\AdvMathIncRankQuantControlsDepVars.smcl"
