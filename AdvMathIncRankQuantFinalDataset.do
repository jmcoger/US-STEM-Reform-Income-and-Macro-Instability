...
*
*This code adds highest education achieved and parent 97 income from wages and salaries, transforms some of the variables for better interpretation of coefficients, then *drops cases with zero values for avginc20172019 or avgparentinc97 and creates incomerank and parentrank variables. 
*
*database used: AdvMathIncRankQuantFinalDataset.dta
*				
*output: AdvMathIncRankQuantFinalDatataset.smcl, AdvMathIncRankQuantFinalDatataset.dta
*
*key variables: N/A
*							
*=====================================================================================================================================================================
...
log using "C:\Users\jcoger\Documents\Essay1\AdvMathWork\AdvMathIncomeRankQuantileV1\logfiles\AdvMathIncRankQuantFinalDataset.smcl"
